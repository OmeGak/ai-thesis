...
It seems the rule \emph{``\text{bunch of red-hued pixels} $\rightarrow$ \text{apple}''} should be sufficient to recognize an apple, no matter if the bunch of pixels appears either centered or shifted to one side.
