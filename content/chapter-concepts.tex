...
\begin{figure}
  \begin{subfigure}[b]{0.35\textwidth}
    ...
    \label{fig:sec:concepts:pooling:general}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.55\textwidth}
    ...
    \captionsetup{justification=centering}
    \caption{Max-pooling}
    \label{fig:sec:concepts:pooling:max}
  \end{subfigure}
  ...
  \label{fig:sec:concepts:pooling}
\end{figure}
...
In Figure~\ref{fig:sec:concepts:convnet} I present the typical configuration of a complete convolutional network.
...
\begin{figure}[htb]
  ...
  \label{fig:sec:concepts:convnet}
\end{figure}
